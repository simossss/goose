...
assert_file_contains "$readiness_device_kind_strict_output" "Phone handoff summary device kind must match android-device-kind.txt." "PR readiness device kind strict"
