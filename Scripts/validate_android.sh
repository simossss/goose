...
assert_file_contains "$final_gate_dry_run_output" "clean worktree: required" "final PR gate dry run"
...
assert_file_contains "$partial_gate_dry_run_output" "clean worktree: required" "partial phone gate dry run"
...
assert_file_contains "$APP_DIR/README.md" "requires a clean git worktree" "root README"
...
assert_file_contains "$ANDROID_DIR/README.md" "requires a clean git worktree" "Android README"
