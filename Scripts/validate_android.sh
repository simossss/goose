...
assert_file_contains "$SCRIPT_DIR/android_final_pr_gate.sh" "Final PR gate requires HEAD" "final PR gate"
...
assert_file_contains "$SCRIPT_DIR/android_partial_phone_gate.sh" "Partial phone gate requires HEAD" "partial phone gate"
